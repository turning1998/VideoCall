export const LOCAL_KEY_USER = 'userInfo';
...
export const MAP_URL = 'https://yfgis.yndk.cn:1000';
...
export const SYS_USER = {
  ...
  SELECTED: 'system:user:selected',
};

// 组织管理
export const SYS_ORG = {
  SAVE: 'system:org:save',
  DELETE: 'system:org:delete',
  UPDATE: 'system:org:update',
  SELECTED: 'system:org:selected',
};
